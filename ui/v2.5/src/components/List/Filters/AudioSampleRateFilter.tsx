...
interface IAudioSampleRateFilterProps {
  criterion: NumberCriterion;
  onValueChanged: (value: INumberValue) => void;
}

export const AudioSampleRateFilter: React.FC<IAudioSampleRateFilterProps> = ({
  criterion,
  onValueChanged,
}) => {
  const intl = useIntl();
    ...
    equalsControl = (
      <Form.Group>
        ...
        <Form.Text className="text-muted">
          {intl.formatMessage({ id: "audio.sample_rate_hint" }, { unit: "Hz" })}
        </Form.Text>
      </Form.Group>
    );
  }
