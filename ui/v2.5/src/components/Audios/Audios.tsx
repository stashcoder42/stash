...
const AudioMarkerList = lazyComponent(() => import("./AudioMarkerList"));
...
const AudioMarkers: React.FC = () => {
  const titleProps = useTitleProps({ id: "markers" });
  return (
    <>
      <Helmet {...titleProps} />
      <AudioMarkerList view={View.AudioMarkers} />
    </>
  );
};
  ...
  return (
    <>
      ...
      <Switch>
        ...
        <Route exact path="/audios/markers" component={AudioMarkers} />
