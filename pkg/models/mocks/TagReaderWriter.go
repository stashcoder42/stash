...
// FindByAudioMarkerID provides a mock function with given fields: ctx, audioMarkerID
func (_m *TagReaderWriter) FindByAudioMarkerID(ctx context.Context, audioMarkerID int) ([]*models.Tag, error) {
	ret := _m.Called(ctx, audioMarkerID)

	var r0 []*models.Tag
	if rf, ok := ret.Get(0).(func(context.Context, int) []*models.Tag); ok {
		r0 = rf(ctx, audioMarkerID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*models.Tag)
		}
