...
func (_m *AudioReaderWriter) GetFiles(ctx context.Context, relatedID int) ([]models.File, error) {
...
// GetUniqueOCount provides a mock function with given fields: ctx
func (_m *AudioReaderWriter) GetUniqueOCount(ctx context.Context) (int, error) {
	ret := _m.Called(ctx)
...
// LastView provides a mock function with given fields: ctx, id
func (_m *AudioReaderWriter) LastView(ctx context.Context, id int) (*time.Time, error) {
	ret := _m.Called(ctx, id)
...
func (_m *AudioReaderWriter) OCount(ctx context.Context) (int, error) {
	ret := _m.Called(ctx)
...
// UpdateCover provides a mock function with given fields: ctx, audioID, image
func (_m *AudioReaderWriter) UpdateCover(ctx context.Context, audioID int, image []byte) error {
	ret := _m.Called(ctx, audioID, image)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int, []byte) error); ok {
		r0 = rf(ctx, audioID, image)
	} else {
		r0 = ret.Error(0)
	}
